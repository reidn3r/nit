...
<div class="<?php echo $class; ?>">
	...
	if (count($items)) {
		foreach ($items as $item_index => $item) {
			...
			if (!empty($item_options['item_title'])) {
				$item_header_id	= RSPageBuilderHelper::createId($item_options['item_title'].'-header', $item_id);
	...
	?>
		<div class="accordion-item">
			<div class="accordion-header" id="<?php echo $item_header_id; ?>">
				<button type="button" class="accordion-button<?php echo $accordion_heading; ?>" data-bs-target="#<?php echo $item_id; ?>" data-bs-toggle="collapse" aria-expanded="<?php echo $accordion_expanded; ?>" aria-controls="<?php echo $item_id; ?>"
			...
			<div class="accordion-collapse collapse<?php echo $accordion_body; ?>" id="<?php echo $item_id; ?>" data-bs-parent="#<?php echo $id; ?>" aria-labelledby="<?php echo $item_header_id; ?>">
				<div class="accordion-body"<?php echo RSPageBuilderHelper::buildStyle($item_content_style); ?>>
