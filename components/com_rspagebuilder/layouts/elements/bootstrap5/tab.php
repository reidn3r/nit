...
<div class="<?php echo $class; ?>">
	...
	<?php if (count($items)) { ?>
		<ul class="nav nav-tabs">
			...
			?>
			<li class="nav-item">
				<a class="nav-link<?php echo $tab_heading; ?>" href="#" id="<?php echo $item_id.'-tab'; ?>" data-bs-toggle="tab" data-bs-target="#<?php echo $item_id; ?>"<?php echo RSPageBuilderHelper::buildStyle($item_title_style); ?>>
			...
			foreach ($items as $item_index => $item) {
				...
				if (!empty($item_options['item_content'])) {
					...
					if ($item_index) {
						...
						$tab_content = ' show active';
					}
					
					// Build Tab item content HTML
			?>
					<div id="<?php echo $item_id; ?>" class="tab-pane fade<?php echo $tab_content; ?>" aria-labelledby="<?php echo $item_id.'-tab'; ?>"<?php echo RSPageBuilderHelper::buildStyle($item_content_style); ?>>
