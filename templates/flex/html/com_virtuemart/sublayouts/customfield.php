		...
		foreach($customfields as $key => $customfield){
			...
			switch ($type) {
				...
				case 'C':
					...
					// Flex 3.9.9 fix for Radios
					$attribs = array('class'=>$class.' cvselection no-vm-bind form-radio','style'=>'min-width:50%;');
					...
					$hash = md5($selector);
					// Disabled in Flex 3.9.9 --- $j = "function r(f){/in/.test(document.readyState)?setTimeout('r('+f+')',9):f()}r(function(){
