...
<form action="<?php echo Route::_($this->query->toUri()); ?>" method="get" class="js-finder-searchform">
	...
	<fieldset class="com-finder__search word mb-3">
		...
		<div class="form-inline">
			<label for="q" class="me-3">
				<?php echo Text::_('COM_FINDER_SEARCH_TERMS'); ?>
			</label>
			<div class="input-group mt-2">
				<div class="col-12 col-md-4 mb-2">
					<input style="height:44px;width:100%!important;" type="text" name="q" id="q" class="col-lg-12 rounded-start py-3 mx-0 form-control" value="<?php echo $this->escape($this->query->input); ?>">
				</div>
				<button type="submit" class="btn btn-primary rounded-start mx-0 mb-2">
					<span class="icon-search icon-white" aria-hidden="true"></span>
					<?php echo Text::_('JSEARCH_FILTER_SUBMIT'); ?>
				</button>
				<?php if ($this->params->get('show_advanced', 1)) : ?>
					<?php HTMLHelper::_('bootstrap.collapse'); ?>
					<button class="btn btn-secondary mx-0 mb-2" type="button" data-bs-toggle="collapse" data-bs-target="#advancedSearch" aria-expanded="<?php echo ($this->params->get('expand_advanced', 0) ? 'true' : 'false'); ?>">
