    ...
    public function render() {
        ...
        if ($use_custom_button) {
			...
			if($button_icon_position == 'left') {
				if ($button_peicon != '') {
					$button_text = ($button_peicon) ? '<i class="pe ' . $button_peicon . '" aria-hidden="true"></i> ' . $button_text : $button_text;
				}else{
					$button_text = ($button_icon) ? '<i class="fa ' . $button_icon . '" aria-hidden="true"></i> ' . $button_text : $button_text;
				}
			} else {
				if ($button_peicon != '') {
					$button_text = ($button_peicon) ? $button_text . ' <i style="margin-left:7px;margin-right:-1px;" class="pe ' . $button_peicon . '" aria-hidden="true"></i>' : $button_text;
				}else{
					$button_text = ($button_icon) ? $button_text . ' <i style="margin-left:5px;margin-right:-1px;" class="fa ' . $button_icon . '" aria-hidden="true"></i>' : $button_text;
				}
			}
        }
            ...
            $output .= '<form class="sppb-ajaxt-contact-form">';
				...
				if ($show_checkbox) {
                    $output .='<div class="tos">';
                        $output .='<label class="sppb-form-check-label" for="agreement-' . $this->addon->id . '">';
                        $output .='<input class="sppb-form-check-input" type="checkbox" name="agreement" id="agreement-' . $this->addon->id . '" required="required"> ' . $checkbox_title;
