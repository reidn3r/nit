            ...
            'attr' => array(
                'general' => array(
					...
					'fluid_tab_width'=>array(
						'type'=>'select',
						'title'=>Text::_('COM_SPPAGEBUILDER_ADDON_TAB_FLUID'),
						'desc'=>Text::_('COM_SPPAGEBUILDER_ADDON_TAB_FLUID_DESC'),
						'values'=>array(
							'fluid'=>Text::_('COM_SPPAGEBUILDER_ADDON_TAB_FLUID_STYLE'),
							'adaptive'=>Text::_('COM_SPPAGEBUILDER_ADDON_TAB_ADAPTIVE_STYLE'),
						),
						'std'=> 'fluid'
					),
                    // Repeatable Item
